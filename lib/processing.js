...
Processing.prototype.viewJam = function(jamid, admin, topcb) {
...
Processing.prototype.recentJams = function(admin, topcb) {
	var that = this;
	var client = sql();
	var onlyPublic = "where private = 0"
	if (admin)
		onlyPublic = ""
	logger.debug(`Grabbing recent jams with admin ${admin}`);
